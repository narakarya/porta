...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git_push_force_with_lease,
            ...
            commands::git_track_remote_branch,
            commands::git_delete_branch,
            commands::git_delete_remote_branch,
            commands::git_branch_diff,
            commands::git_branch_diff_options,
            ...
            commands::get_git_theme,
            commands::set_git_theme,
            commands::git_worktree_list,
            commands::git_worktree_add,
            commands::git_log,
            commands::git_log_ref,
            commands::git_show,
            commands::git_show_options,
            ...
            commands::git_stash_show_options,
            ...
            commands::git_rebase_plan,
            commands::git_rebase_start,
            commands::git_operation_state,
            commands::git_rebase_onto,
            commands::git_rebase_abort,
            commands::git_rebase_continue,
            commands::git_rebase_main,
            commands::git_pr_capability,
            commands::git_pr_list,
            commands::git_pr_view,
            commands::git_pr_diff,
            commands::git_pr_checkout,
            ...
            commands::brew_available,
            commands::run_provision_step,
            commands::cancel_provision_step,
