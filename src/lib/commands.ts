...
// ── Git ───────────────────────────────────────────────────────────────────────
//
// Core keeps only what the app card / workbench header GitBadge, the
// run-on-branch picker and worktree instances need. Everything richer —
// staging, commits, history, stash, tags, rebase, PRs — lives in the
// `git-manager` extension, which drives git through `extension_shell_run`
// rather than through typed IPC.
