...
export default function ServiceSelectionBar({ selectedIds, onClear }: Props) {
  ...
  return (
    <div
      className="fixed bottom-20 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 px-3 py-2 bg-surface-2 border border-violet-500/30 rounded-xl shadow-2xl"
      role="toolbar"
