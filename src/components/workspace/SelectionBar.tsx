...
export default function SelectionBar({ selectedIds, onClear }: Props) {
  ...
  return (
    <div
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 px-3 py-2 bg-surface-2 border border-white/[0.12] rounded-xl shadow-2xl"
      role="toolbar"
      aria-label="Bulk app actions"
    >
      <span className="text-[11px] font-medium text-ink px-2">
      ...
      <button
        onClick={startAll}
        disabled={!canStart}
        className="px-2.5 py-1 text-[11px] font-medium text-accent bg-accent-bg hover:bg-accent-bg rounded-md transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
      ...
      <button
        onClick={restartAll}
        disabled={!canRestart}
        className="px-2.5 py-1 text-[11px] font-medium text-warn bg-warn-bg hover:bg-warn-bg rounded-md transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
      ...
      <button
        onClick={stopAll}
        disabled={!canStop}
        className="px-2.5 py-1 text-[11px] font-medium text-ink-2 bg-white/[0.06] hover:bg-white/[0.10] rounded-md transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
      ...
      <button
        onClick={onClear}
        className="px-2.5 py-1 text-[11px] font-medium text-ink-3 hover:text-ink hover:bg-white/[0.06] rounded-md transition-colors"
