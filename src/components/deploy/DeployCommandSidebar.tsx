      ...
      <div className="border-t border-white/[0.05] px-3 py-2 space-y-2">
        ...
        {!kamalChecking && !kamalInstalled && (
          <button
            ...
            disabled={cmdStates["__install__"]?.running}
            className={`w-full px-2 py-1.5 rounded-md text-[11px] font-medium transition-colors ${
              cmdStates["__install__"]?.running
          ...
          >
            ...
            ) : cmdStates["__install__"]?.exitCode != null && cmdStates["__install__"]?.exitCode !== 0 ? (
              "Retry Install"
            ) : (
              "Install Kamal"
            )}
