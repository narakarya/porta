  ...
  return (
    <>
      ...
      {hostsMenuOpen && createPortal(
        <div
          ref={panelRef}
          className="fixed z-[60] min-w-[180px] bg-surface-2 border border-white/[0.10] rounded-lg shadow-xl overflow-hidden"
        ...
        >
          {hosts.map((h) => (
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 text-[12px] font-mono text-ink-2 hover:bg-white/[0.07] transition-colors"
            >
